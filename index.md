...
<a class="button" href="{{ '/cv' | relative_url }}" data-style="bare" aria-label="For my full CV, click here">  <i class="fa-solid fa-arrow-right"></i> For my full CV, click here </a>
{% endcapture %}
...
<a class="button" link="research" style="bare" <i class="fa-solid fa-arrow-right"></i> Learn more </a>
{% endcapture %}
